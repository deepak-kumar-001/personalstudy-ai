...
# Allow frontend access - Vercel handles CORS but we add this for safety
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Vercel will be on same domain
...
@app.get("/api")
def home():
    return {"message": "✅ PersonalStudy API is running on Vercel!"}
